...
#登录信息  
    ...
    for i in range(num):
        playData = {'amount':userData['amount']}
        urlKd1 = 'http://'+userData['testStr']+userData['environmentNum']+'-wap.stg2.24cp.com/?act=game_crazymahjong&st=play'
        result1 = str(i)+": "+PostUrlRequest(urlKd1,playData)
        jsonData = json.loads(PostUrlRequest(urlKd1,playData))
        print(result1)
        ...
        result2 = str(i)+": "+PostUrlRequest(urlKd2,replayInfo)
        print(result2)
